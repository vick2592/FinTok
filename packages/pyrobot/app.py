...
if __name__ == "__main__":
    ...
    train_multiprocessing(CustomEnv, agent, train_df, train_df_nomalized, num_worker = 16, training_batch_size=500, visualize=False, EPISODES=2)
    ...
    #test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 16, visualize=True, test_episodes=1000, folder="2023_06_19_01_48_Crypto_trader", name="1913.03_Crypto_trader", comment="3 months")
